...
# Calculate scores
	...
	for i in range(maxnode):
		...
		if len(firstMax) == 1:
			...
			if len(firstMax) == 1:
				...
				if len(firstMax) == 1:
					...
					selNode = firstMax[0]
		#Swap the coloumns and rows between the current node and the selected one
		...
		#print(Matrix)
# Create new file
	newFile = os.getcwd() + "\\"+directoryName+ "2\\" + os.path.basename(filename)
